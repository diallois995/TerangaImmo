            ...
            <div class="discount-product-slider dots-bottom-right">
                ...
                <div class="col-lg-12">
                    <div class="discount-product">
                        <img src="{{ asset('templates/templateVitrine/img/discount/1.jpg')}} ')}}" alt="" />
                ...
                <div class="col-lg-12">
                    <div class="discount-product">
                        <img src="{{ asset('templates/templateVitrine/img/discount/2.jpg')}} ')}}" alt="" />
                        <div class="discount-img-brief">
                            <div class="onsale">
                                <span class="onsale-text">On Sale</span>
                                <span class="onsale-price">$ 80.00</span>
                ...
                <div class="col-lg-12">
                    <div class="discount-product">
                        <img src="{{ asset('templates/templateVitrine/img/discount/3.jpg')}} ')}}" alt="" />
                        <div class="discount-img-brief">
                            <div class="onsale">
                                <span class="onsale-text">On Sale</span>
                                <span class="onsale-price">$ 80.00</span>
                ...
                <div class="col-lg-12">
                    <div class="discount-product">
                        <img src="{{ asset('templates/templateVitrine/img/discount/4.jpg')}}" alt="" />
                        <div class="discount-img-brief">
                            <div class="onsale">
                                <span class="onsale-text">On Sale</span>
                                <span class="onsale-price">$ 80.00</span>
