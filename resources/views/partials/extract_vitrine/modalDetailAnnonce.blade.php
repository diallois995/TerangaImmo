                     ...
                     <div class="modal-product">
                         <div class="product-images">
                             <div class="main-image images">
                                 <img alt="#" src="{{ asset('templates/templateVitrine/img/product/quickview-photo.jpg')}}"/>
                             </div>
                         </div><!-- .product-images -->
                         ...
                         <div class="product-info">
                             ...
                             <a href="{{ asset('templates/templateVitrine/shop.html')}}" class="see-all">See all features</a>
