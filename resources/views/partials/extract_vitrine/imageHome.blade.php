    ...
    <div class="banner-left floatleft">
        ...
        <div class="slider-banner">
            <div class="single-banner banner-1">
                <a class="banner-thumb" href="#"><img src="{{ asset('templates/templateVitrine/img/banner/1.jpg') }}" alt="" /></a>
            ...
            <div class="single-banner banner-2">
                <a class="banner-thumb" href="#"><img src="{{ asset('templates/templateVitrine/img/banner/2.jpg') }}" alt="" /></a>
                <div class="banner-brief">
        ...
        <div class="slider-area">
            <div class="bend niceties preview-2">
                <div id="ensign-nivoslider" class="slides">
                    <img src="{{ asset('templates/templateVitrine/img/slider/slider-1/1.jpg') }}" alt="" title="#slider-direction-1"  />
                    <img src="{{ asset('templates/templateVitrine/img/slider/slider-1/2.jpg') }}" alt="" title="#slider-direction-2"  />
                    <img src="{{ asset('templates/templateVitrine/img/slider/slider-1/3.jpg') }}" alt="" title="#slider-direction-3"  />
                </div>
                <!-- direction 1 -->
        ...
        <div class="table">
            <div class="table-cell">
                <ul>
                    ...
                    <li><a href="{{ route('login') }}" title="My-Account"><i class="zmdi zmdi-account"></i></a></li>
                    <li><a href="{{ asset('templates/templateVitrine/wishlist.html') }}" title="Wishlist"><i class="zmdi zmdi-favorite"></i></a></li>
                </ul>
            </div>
        </div>
    </div>
