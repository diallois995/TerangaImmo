      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form method="POST" action="{{ route('annonce.store')}}" enctype="multipart/form-data" novalidate>
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="titre" name="titre" type="text" class="form-control @error('titre') is-invalid @enderror" value="{{ old('titre')}}" required autocomplete="titre">
                        @error('titre')
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="montant" name="montant" type="number" class="form-control @error('montant') is-invalid @enderror" value="{{ old('montant')}}" required autocomplete="montant">
                        @error('montant')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row mb-3">
                 ...
                 <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="dateLimite" name="dateLimite" type="date" class="form-control @error('dateLimite') is-invalid @enderror" value="{{ old('dateLimite')}}" required autocomplete="dateLimite">
                        @error('dateLimite')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
