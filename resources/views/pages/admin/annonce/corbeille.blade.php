...
@section("admin")
  <div class="pagetitle">
    <h1>Annonces supprimées - Cobeille</h1>
    <nav>
      <ol class="breadcrumb">
      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <button onclick="document.location='{{route('annonce.index')}}'" style="float: right;" class="btn btn-primary mt-3">
                <b> Afficher liste des annonces</b>
            </button>
